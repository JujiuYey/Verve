...
--   learning/001_schema.sql(learning_objectives, learning_sessions)
-- ============================================
...
CREATE INDEX idx_learning_memory_events_objective_id ON learning_memory_events(objective_id);
...
CREATE INDEX idx_learning_memory_items_objective_id ON learning_memory_items(objective_id);
