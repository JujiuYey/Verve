...
{"verdict":"pass|partial|fail","mastery_after":"none|seen|heard|explained|written|verified","feedback":"具体反馈","evidence":"本次判定依据","weak_points":["薄弱点"],"improvement_suggestion":"改进建议","review_required":true}
...
- improvement_suggestion 只针对本次作答给一个具体补强建议,不要规划下一个学习小节,不要假设页面存在下一步流程;
